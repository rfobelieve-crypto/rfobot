...
| **SDV**（策略 #2b·新線） | **意圖層 HALTED，實盤未上**（2026-09-09） | 樣本外 S+D+V（n=877、458 天、返佣後）每筆 **+0.1833 ATR**、CI [−0.132, +0.550]、**9/9 幣**、**P(優勢>0) 85.0%**、勝率 47.9%、PF 1.191、年化夏普 +0.93、樣本外/樣本內 **36%**。回落（2x／3 槽，1500 條重抽路徑）p50 **43.3%**、p95 59.7%、**P(回落>50%) 24.1%**（活數字跑 `research/poc/conj_bet.py`）。**出場網格 15 格沒有任何一格 CI 下緣越過零**。前瞻時鐘：全簽章 3/300、S+D+V 1/200。方向仍是動能（B1–B4 四個判別臂樣本外全滅）|
