...
| **流動性獵取**（策略 #2） | **變體 B 判決 FAIL（2026-09-02）**；正式軌道 A 繼續 forward 記帳 | 變體 B（＋淺穿越濾網·29幣）**1428/1400 達標、日聚類 CI 下緣 −0.094、meanR −0.010 → FAIL**；C（767/400）、D（371/400）**連坐作廢**。Gate F 正式軌道（變體 A·無濾網·core9）**292/1400**、CI [−0.087, +0.175] 含零、5/9 幣正 → 累積中（~2027-01 中到期）。提前止損條款未觸發（quasi +0.030 / forward +0.047）。**判決全文 TODO §0.92，註冊簿 §0.43** |
