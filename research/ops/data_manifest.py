...
REGISTRY = [
    ...
    #                                清算 taker_fee 10000 對上 liquidation_fee 1%）
    #   taker/maker_position_size_before   雙方成交前的部位
    ...
    #   少了 per-level 掛單筆數（Lighter 的 L2 只有 price+size）
    #        -> **佇列位置那一族研究在這裡做不了**，bid_levels 是檔數不是筆數
